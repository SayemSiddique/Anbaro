...
| `BILLING_ENABLED`                | unset                   | unset until Session 11     | unset until Session 11                      | **Session 11 now targets go-live, not a fast-follow (2026-09-02) — flip only once Stripe is actually live in that env, never before** |
