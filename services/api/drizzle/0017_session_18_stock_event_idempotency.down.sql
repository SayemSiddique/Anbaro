-- Reverses 0017: restores the original 6-argument apply_manual_stock_event and
-- removes the idempotency key column and index.
...
DROP INDEX IF EXISTS stock_events_org_idempotency_key;
ALTER TABLE stock_events DROP COLUMN IF EXISTS idempotency_key;
