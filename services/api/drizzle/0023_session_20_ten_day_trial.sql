...
-- as 0003 left it except for the trial_end interval.
...
BEGIN
  ...
  INSERT INTO public.subscriptions (organization_id, plan_id, status, trial_start, trial_end) VALUES (v_organization_id, v_trial_plan_id, 'trialing', now(), now() + interval '10 days');
